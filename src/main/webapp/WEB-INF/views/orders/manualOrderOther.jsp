...
<body>
	...
	<c:url var="findItemsByCatId" value="/getItemsOfMenuIdOther" />
	<c:url var="findAllMenus" value="/getMenuForOrderOther" />
	<c:url var="insertItem" value="/insertItemOther" />
	<c:url var="deleteItems" value="/deleteItemsOther" />
	<c:url var="generateManualBill" value="/generateManualBillOther" />
	...
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i> Manual Order2
					</h1>
				</div>
			</div>
			<!-- END Page Title -->
